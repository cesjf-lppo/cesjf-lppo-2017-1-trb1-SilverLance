                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Equipamentos<span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="lista.html">Todos os Equipamentos</a></li>
                                <li class="divider"></li>
                                <li><a href="lista.html?filtro=0">Novo</a></li>
                                <li class="divider"></li>
                                <li><a href="lista.html?filtro=1">Em Uso</a></li>
                                <li class="divider"></li>
                                <li><a href="lista.html?filtro=2">Danificado</a></li>
                                <li class="divider"></li>
                                <li><a href="lista.html?filtro=3">Perdido</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
