        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid"> 
                <div class="navbar-header">
                    ...
                    <a class="collapse navbar-collapse" href="index.html"> <img width="100px" height="55px" class="img-responsive" src="../Icone/exculir.png" alt="Pagina Inicial"/></a></div>
                <div class="collapse navbar-collapse" id="defaultNavbar1">
                    <ul class="nav navbar-nav">
                        <li><a href="novo.html">Novo Cadastro</a></li>
                        <li><a href="lista.html">Lista de Equipamentos</a></li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Equipamentos<span class="caret"></span></a>
